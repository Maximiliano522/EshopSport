...
<body>
    ...
    <span class="logo">Fashion</span>
        <div class="sm-product">
            ...
            <div class="sm-product-img-container">
                <img src="./img/img1.jpg" id = "img1" alt="" class="sm-product-img">
            </div>
            <p class="sm-product-des">
                Gran y nuevo diseño de los diseñadores de la marca Nueva York
            </p>
        </div>
    ...
    <div class="right-side">
        <img src="./img/img1.jpg" id ="img1" alt="" class="backdrop-img">
        <div class="content">
            <div class="product-detail">
                <h1 class="product-name">Blue York</h1>
                <p class="product-des">
